package dev.powercyphe.combustible_depths.client;

import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking;
import net.fabricmc.fabric.api.client.particle.v1.ParticleProviderRegistry;
import net.minecraft.client.renderer.entity.EntityRenderers;
import dev.powercyphe.combustible_depths.client.particle.IgniteExplosionParticle;
import dev.powercyphe.combustible_depths.client.particle.IgniteShardParticle;
import dev.powercyphe.combustible_depths.client.render.PrimedIgniteEntityRenderer;
import dev.powercyphe.combustible_depths.common.payload.IgniteExplosionPayload;
import dev.powercyphe.combustible_depths.common.registry.CDEntities;
